          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-[#6E7A8A] leading-relaxed">
                Manage your finances, build healthy routines, and stay organized in one powerful platform.
NexWise helps students plan better, stay focused, and take control of their daily life.
              </p>
              <p className="text-xl md:text-2xl font-semibold text-[#3EC6A8]">
